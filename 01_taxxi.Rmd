...
*S* is the **test set** while the **training set** is *A*, which is formed by the union of *T*and *W*.\
...
Modify header to be in this format : 
>gi_636560836;tax=d:Bacteria,p:Firmicutes,c:Bacilli,o:Bacillales,f:Alicyclobacillaceae,g:Alicyclobacillus;

https://scikit-learn.org/stable/modules/cross_validation.html 

Edgar_anacapa_BLCA_classifier_test_config.sh to test for TAXXI matrics
