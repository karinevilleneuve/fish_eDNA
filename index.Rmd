...
The dataset consists of 18 water samples collected from rivers and lakes near oil-sands extraction sites in the province of Alberta, Canada. Sampled water was filtered and DNA collected on the filers was extracted and sequenced. For each sample collected, two different marker genes were used to amplify and sequence distinct DNA regions : the **12S** ribosomal RNA gene and the mitochondrial cytochrome oxidase subunit (**COI**). 
...
Each databases were queried to evaluate the presence of reference sequences for Alberta freshwater fishes. Code used can be found [here][Evaluating representation in databases]. 
