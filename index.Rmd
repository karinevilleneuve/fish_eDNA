...
Each database was queried to evaluate the presence of reference sequences for Alberta freshwater fishes. Code used to queried the databases can be found [here][Evaluating representation in databases]. 
